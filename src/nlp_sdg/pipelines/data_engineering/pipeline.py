...
from nlp_sdg.pipelines.data_engineering.nodes import dummy_node, clean_agreement, clean_text
...
def create_pipeline(**kwargs) -> Pipeline:
    ...
    data_engineering = pipeline(
        ...
        outputs = ["model_input_data", "cleaned_agreement_data", "cleaned_text_data"]
    )
